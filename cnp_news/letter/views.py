...
#**************************************************************************************
#Display a newsletter in browser
#**************************************************************************************
def Home(request):
   return render_to_response('letter/home.html', {  }, context_instance=RequestContext(request))
...
#**************************************************************************************
def __SelectMessages(isExternal, year=None, month=None, day=None):
...
#**************************************************************************************
def SelectEventMessages(year=None, month=None, day=None):
...
# 'isExternal' parameter is set to True or False, respectively
#**************************************************************************************
def __BuildNewsletter(isExternal, year=None, month=None, day=None):
    try:
        now = datetime.now()
        ...
        subjects = __SelectMessages(isExternal, year, month, day)
...
#**************************************************************************************
def BuildNewsletter(request, year=None, month=None, day=None):

    ret = []

    # Build the internal newsletter
    res_val, res_msg = __BuildNewsletter(False, year=None, month=None, day=None)
    if not res_val:
        return HttpResponse('Error %s' % res_msg)
    ret.append(res_msg)

    # Build the external newsletter
    res_val, res_msg = __BuildNewsletter(True, year=None, month=None, day=None)
    if not res_val:
        return HttpResponse('Error %s' % res_msg)
    ret.append(res_msg)
...
#**************************************************************************************
#def BuildEvent(request, sdate=None):
#
#        if( sdate == None ):
#            date = datetime.now()
#        else:
#            date = datetime.strptime( sdate, "%Y%m%d" )
def BuildEvent(request, year=None, month=None, day=None):
    ...
    try:
        ...
        messages = SelectEventMessages(year, month, day)
...
#**************************************************************************************
def SendNewsletter(request, id=None, year=None, month=None, day=None):
    try:
        now = datetime.now()
...
#**************************************************************************************
def ShowNewsletter(request, scope, id=None, year=None, month=None, day=None):
...
# For test
#**************************************************************************************
def TestNewsletter(request, scope, year=None, month=None, day=None):
    if not request.user.is_authenticated():
        return HttpResponse('You need to login')
    ...
    try:
        ...
        if scope == 'int': subjects = __SelectMessages(False, year, month, day)
        elif scope == 'ext': subjects = __SelectMessages(True, year, month, day)
...
# For test
#**************************************************************************************
def TestEvent(request, year=None, month=None, day=None):
    if not request.user.is_authenticated():
        return HttpResponse('You need to login')
